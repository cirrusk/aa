...
//		firstPageLabel    = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \"><img src=\"" + servletContext.getContextPath() +  "/images/lms/process/headbut.gif\" alt=\"처음\"   border=\"0\"/></a>&#160;";
//        previousPageLabel = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \"><img src=\"" + servletContext.getContextPath() +  "/images/lms/process/forwardbut.gif\"    alt=\"이전\"   border=\"0\"/></a>&#160;";
        ...
        currentPageLabel  = "<a href=\"#\" class='on'><strong>{0}</strong></a>&#160;";
...
//        nextPageLabel     = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \"><img src=\"" + servletContext.getContextPath() +  "/images/lms/process/nextbut.gif\"    alt=\"다음\"   border=\"0\"/></a>&#160;";
//        lastPageLabel     = "<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \"><img src=\"" + servletContext.getContextPath() +  "/images/lms/process/lastbut.gif\" alt=\"마지막\" border=\"0\"/></a>&#160;";
