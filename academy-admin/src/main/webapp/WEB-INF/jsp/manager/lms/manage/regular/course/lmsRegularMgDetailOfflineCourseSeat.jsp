	...
	$.ajaxCall({
		 ...
		 function goUpdate(seatseq,seatuseflag)
		{
			...
			$.ajaxCall({
				...
				, data: "courseid="+$("#stepcourseid").val()+"&seatseq="+seatseq+"&seatuseflag="+seatuseflag
				, success: function(data, textStatus, jqXHR){
					seatList.doSearch();
				},
				error: function( jqXHR, textStatus, errorThrown) {
...
<body class="bgw">
	<form id="frm" name="fileform" method="post" enctype="multipart/form-data">
		<input type="hidden" id="stepcourseid"  name="courseid" value="${stepcourseid }">
				...
				<table id="tblSearch" width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<td style="height:25px;">
							...
							성공 : <span id="successCount">성공</span>건, 오류: <span id="failCount">오류</span>건  <a href="javascript:;" id="logBtn" class="btn_green"> 로그보기</a>
							</span>	
						</td>
					</tr>
