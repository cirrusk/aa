...
$(document).ready(function(){
	$("#insertBtn").on("click", function(){
		...
		var param = {
				...
				, passpoint : $("#passpoint").val()
				
		};
		$.ajaxCall({
	   		url: "/manager/lms/course/lmsRegularCourseEditTestSaveAjax.do"
	   		, data: param
	   		, async : false
...
<input type="hidden" id="coursetype" name="coursetype" value="${detail.coursetype}">
					<table id="tblSearch" width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<th id="coursetypenametitle">시험명</th>
							<td>
								${detail.coursename }
							</td>
						</tr>				
						<tr>
							<th id="edudatetitle">시험기간</th>
							<td>
						...
						<tr>
							<th>통과점수</th>
							<td>
								<input type="text" id="passpoint" name="passpoint" title="통과점수" class="required isNum" style="width:auto; min-width:30px;" value="${detail2.passpoint}" maxlength="2"/> 점 이상
							</td>
						</tr>
