		...
		*/		
		init : function() {
			...
			var _colGroup = [
							...
							, {key:"themename", label:"오프라인테마", width:"150", align:"center", sort:false}
							, {key:"coursename", label:"과정명", width:"400", align:"center", sort:false}
							, {key:"apname", label:"교육장소", width:"80", align:"center", sort:false}
...
function goDetail(courseId)
{
		//교육신청자 추가 버튼 클릭
			var popParam = {
					...
					, height : 900
					, maxHeight : 900
					, params : {courseid : courseId, coursetype : "F"}
					, targetId : "reportPop"
			}
