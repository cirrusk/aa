...
$(document.body).ready(function(){
	...
	$("#insertExcelBtn").on("click",function(){
		...
		if(checkManagerAuth($("#managerMenuAuth").val())){return;}
			...
			var popParam = {
					url : "/manager/lms/manage/regular/course/lmsRegularMgDetailOfflineAttendExcelPop.do"
					, width : 1024
					, height : 600
					, maxHeight : 600
	...
	$("#attendBarcodeBtn").on("click",function(){
		...
		if(checkManagerAuth($("#managerMenuAuth").val())){return;}
		var popParam = {
				url : "/manager/lms/manage/regular/course/lmsRegularMgDetailOfflineAttendBarcodePop.do"
				, width : 1024
				, height : 900
				, maxHeight : 900
				, params : {stepcourseid : $("#stepcourseid").val() , stepseq : $("#stepseq").val(), courseid : $("#courseid").val()}
	...
	$("#saveBtn").on("click",function(){
		...
		if( !confirm("출석 정보를 저장하시겠습니까?") ) {
			return;
		}
		
		$.ajaxCall({
	   		url: "<c:url value="/manager/lms/manage/regular/course/lmsRegularMgOfflineAttendUpdateAjax.do"/>"
	   		, data: param
			...
			<tr>
				...
				<div class="contents_title clear">
					...
					<div class="fr">
						...
						<a href="javascript:;" id="saveBtn" class="btn_green" style="vertical-align:middle">출석여부 저장</a>
					</div>
				</div>
