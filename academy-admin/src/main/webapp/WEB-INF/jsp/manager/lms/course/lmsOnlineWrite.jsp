...
$(document.body).ready(function(){
	...
	fnCheckLength('coursecontent',110);
});
...
var imageSubmit = function(){
	...
	if($("#coursecontent").val().length > 110){
		alert("교육소개를 110자 이내로 입력해 주세요.");
		$("#coursecontent").focus();
		return;
	}
	...
	if(openflag == "C"){
		...
		$("#enddate").val("2050-12-31 23:50:59");
	}
...
var saveSubmit = function(){
	...
	$.ajaxCall({
   		url : "<c:url value="/manager/lms/course/lmsOnlineSaveAjax.do"/>"
...
<body class="bgw">
	...
	<!--search table // -->
	<div class="tbl_write">
<form id="frm" name="frm" method="post" style="border:0px;">
...
<input type="hidden" id="old_openflag" name="old_openflag" value="${detail.openflag}" />
		...
		<table id="tblSearch" width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<th>Activity ID</th>
				<td>
					<input type="text" id="activityid" name="activityid" style="width:120px;" value="${detail2.activityid}" class="AXInput required" maxlength="25" title="Activity ID">
					&nbsp;&nbsp;&nbsp;&nbsp;코스코드&nbsp;&nbsp;
					<input type="text" id="activitycode" name="activitycode" style="width:120px;" value="${detail2.activitycode}" class="AXInput required" maxlength="25" title="코스코드">
				</td>
			</tr>										
		</table>
		<br/>
		...
		<table id="tblSearch2" width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
				<th>교육소개</th>
				<td colspan="2">
					<textarea id="coursecontent" name="coursecontent" class="AXInput required" style="width:90%;height:100px;" title="교육소개" onkeyup="javascript:fnCheckLength('coursecontent',110);" onkeydown="javascript:fnCheckLength('coursecontent',110);">${detail.coursecontent}</textarea>
					<br><span class="byte" id="coursecontentSpan">0/110자</span>
				</td>
			</tr>
			<tr>
				<th>시청(상영)시간</th>
