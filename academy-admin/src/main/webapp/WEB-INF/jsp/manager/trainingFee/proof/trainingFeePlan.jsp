...
$(document.body).ready(function(){
	...
	$("#btnSearch").on("click", function(){
		trainingFeePlan.doSearch({page:1});
	});
	...
	$("#getGridDetailView").on("click", function(){
		getGridDetailView(trainingFeePlanGrid.getExcelFormat("html"));
	});
});
...
// 							, {key:"planstatus", addClass:idx++, label:"상태", width:"60", align:"center", formatter: function(){
// 								var txt = "진행중";
// 								if(this.item.planstatus=="Y") txt = "완료";								
// 								return txt;
// 							}}
							...
							, {key:"grpstatus", addClass:idx++, label:"상태", width:"60", align:"center", formatter: function(){
								var txt = "진행중";
								if(this.item.grpstatus=="Y"||this.item.planstatus=="Y") txt = "제출완료";								
								return txt;
							}}
							, {key:"totalamount", addClass:idx++, label:"합계", width:"100", align:"center", formatter: "money"}
							, {key:"selfApprovalEnDt", addClass:idx++, label:"상세보기", width:"150", align:"center", formatter: function(){
							 	return "<a href=\"javascript:;\" class=\"btn_green\" onclick=\"trainingFeePlan.doSearchTab('" + this.item.giveyear + "','" 
							 			                                                                                          + this.item.givemonth + "','" 
							 			                                                                                          + this.item.depabo_no + "','" 
...
// 									, {colSeq: 4, rowspan: 2, valign:"middle"}
									, {colseq:null, colspan: 6, label: "사전 계획서", align: "center", valign:"middle"}
			...
			// Grid Page List
			trainingFeePlan.doSearch({page:pageNo});
			...
			$.extend(defaultParam, initParam);
 		   	...
 		   	$.ajaxCall({ 		   		
		   		url: "<c:url value="/manager/trainingFee/proof/trainingFeePlanListAjax.do"/>"
		   		, data: defaultParam
		   		, bLoading : "Y"
		...
		doSearchTab : function(giveyear, givemonth, abono, trfee, spendamount, grtamount) {
			// 상세 tabpage
			var strMenuCd   = "";
			var strMenuText = "";
			var strLinkurl = "";
			
			strMenuCd = "W03020020010";
			strMenuText = "사전교육계획서 상세보기";
			strLinkurl = '/manager/trainingFee/proof/trainingFeePlanDetail.do';
