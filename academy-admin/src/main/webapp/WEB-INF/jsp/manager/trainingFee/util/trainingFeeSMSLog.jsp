...
var defaultParam = {
 	...
 	, sortColKey: "trainingfee.util.utillist1"
 	, sortIndex: 0
 	, sortOrder:"DESC"
};
		...
		*/		
		init : function() {
			...
			var _colGroup = [
							...
							, {key:"registrantdate", label:"처리일시", width:"100", align:"center"}
							, {key:"senddate", label:"발송일시", width:"100", align:"center"}
							, {key:"depabo_no", label:"ABO 번호", width:"60", align:"center"}
							, {key:"name", label:"ABO 이름", width:"100", align:"center"}
							, {key:"notetext", addClass:idx++, label:"맞춤쪽지내용", width:"200", align:"left"}
							, {key:"smstext", addClass:idx++, label:"SMS전송내용", width:"200", align:"left"}
						]
			...
			$.extend(defaultParam, initParam);
 		   	...
 		   	$.ajaxCall({ 		   		
		   		url: "<c:url value="/manager/trainingFee/util/selectSMSLog.do"/>"
		   		, data: defaultParam
...
<body class="bgw">
	...
	<div class="contents_title clear">
		<h2 class="fl">SMS발송이력</h2>
		<div class="fr">
			<ul class="navigation">
				<li class="home"><a href="#">홈으로</a></li>
				<li><a href="#">교육비</a></li>
				<li><a href="#">UTIL</a></li>
				<li class="end"><a href="#">SMS발송이력</a></li>
			</ul>
		</div>
	</div>
