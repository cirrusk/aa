...
var defaultParam = {
    ...
    , rowPerPage: "${rowPerCount}"
 	, sortColKey: "trainingfee.agree.agreelist2"
 	, sortIndex: 1
 	, sortOrder:"DESC"
};
		...
		*/		
		init : function() {
			...
			var _colGroup = [
							...
							, {key:"depaboname", addClass:idx++, label:"ABO 이름", width:"150", align:"center"}
							, {key:"thirdperson", addClass:idx++, label:"ABO 번호", width:"80", align:"center"}
							, {key:"thirdpersonname", addClass:idx++, label:"ABO 이름", width:"150", align:"center"}
							, {key:"groupcode", addClass:idx++, label:"운영그룹", width:"80", align:"center"}
							, {key:"agreeflag", addClass:idx++, label:"동의여부", width:"80", align:"center"}
							, {key:"agreedate", addClass:idx++, label:"동의일자", width:"100", align:"center"}
							, {key:"registrantdate", addClass:idx++, label:"등록일자", width:"100", align:"center"}
							, {key:"agreetitle", addClass:idx++, label:"서약서 제목", width:"200", align:"center"}
							, {key:"agreeid", addClass:idx++, label:"버전", width:"60", align:"center"}
							, {key: "btns", label : "출력버튼", width: "80", align: "center", formatter: function(){
								var html = "";
								if( !isNull(this.item.agreeflag) ) html = "<a href=\"javascript:;\" class='btn_green' onclick=\"javascript:agreeLogPrint('" + this.item.fiscalyear + "','" + this.item.depabo_no + "')\">동의서출력</a>"; 
							 	return html;
							  }}
						]
					...
					, colHead : { heights: [25,25],
				          rows : [
			                     [
									...
									, {colseq:null, colspan: 2, label: "동의자", align: "center", valign:"middle"}
									, {colseq:null, colspan: 2, label: "제3자 동의", align: "center", valign:"middle"}
			...
			$.extend(defaultParam, initParam);
 		   	...
 		   	$.ajaxCall({
		   		url: "<c:url value="/manager/trainingFee/agreelist/selectThirdpersonLog.do"/>"
		   		, data: defaultParam
...
<body class="bgw">
	...
	<div class="contents_title clear">
		<h2 class="fl">교육비 제3자 동의현황</h2>
		<div class="fr">
			<ul class="navigation">
				<li class="home"><a href="#">홈으로</a></li>
				<li><a href="#">교육비</a></li>
				<li><a href="#">약관동의현황</a></li>
				<li class="end"><a href="#">교육비제3자동의</a></li>
			</ul>
		</div>
	</div>
