...
<script type="text/javascript">
    //Grid Init
    var adminCancelPopGrid = new AXGrid(); // instance 상단그리드
    ...
    $(document).ready(function(){
        ...
        fnGrid.nonPageGrid(adminCancelPopGrid, gridParam);
        doSearch();
        ...
        $("#saveBtn").on("click", function (){
            ...
            var penaltyseq = "";
            var checkedList = adminCancelPopGrid.getCheckedListWithIndex(0);// colSeq
            ...
            var param ={
               ...
               ,rsvsessionseq : $("#sessionseq").val()
               ,roomseq :$("#roomseq").val()
               ,cookType: $("#cookType").val()
            }

            $.ajaxCall({
                url: "<c:url value="/manager/reservation/facilityInfo/facilityInfoDetailThreeCancelInsert.do"/>"
                , data: param
                , success: function(data, textStatus, jqXHR){
                	if(data.result.errCode < 0){
	                    ...
	                    if("Y" == $("input[name='cookType']").val()) {
	                        eval($('#ifrm_main_'+frmId).get(0).contentWindow.doReturn("cookCancelList"));
	                    }else if("N" == $("[name='cookType']").val()) {
	                        eval($('#ifrm_main_'+frmId).get(0).contentWindow.doReturn("cancelList"));
	                    }
    ...
    function doSearch(){
        ...
        var sUrl = "";
        var type = $("#cookType").val();

        sUrl= "<c:url value="/manager/reservation/facilityInfo/facilityInfoDetailThreeCancelPopListAjax.do"/>"
        ...
        function callbackList(data) {
            ...
            // Grid Bind Real
            adminCancelPopGrid.setData(gridData);
        }
    }
...
<div id="popwrap">
    <form:form id="listForm" name="listForm" method="post">
        ...
        <input type="hidden" id="sessionseq" value="${layerMode.rsvsessionseq}"/>
