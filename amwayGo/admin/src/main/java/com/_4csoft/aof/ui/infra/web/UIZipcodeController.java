...
public class UIZipcodeController extends BaseController {
	...
	public ModelAndView listOld(HttpServletRequest req, HttpServletResponse res, UIZipcodeCondition condition) throws Exception {
		...
		System.out.println("condition.getSrchType():1:"+condition.getSrchType());
		System.out.println("condition.getSrchKey():2:"+condition.getSrchKey());
		System.out.println("condition.getSrchWord():3:"+condition.getSrchWord());
