...
doInitializeLocal = function() {
	...
	forSearch.config.url    = "<c:url value="/univ/course/discuss/template/list/popup.do"/>";
	...
	forDetail.config.url    = "<c:url value="/univ/course/discuss/template/detail/popup.do"/>";
	...
	<c:forEach var="row" items="${paginate.itemList}" varStatus="i">
		<tr>
	        <td>
	        	...
	        	<input type="hidden" name="templateSeq" value="<c:out value="${row.discussTemplate.templateSeq}" />">
	        	<input type="hidden" name="templateTitle" value="<c:out value="${row.discussTemplate.templateTitle}" />">
	        	<input type="hidden" name="templateDescription" value="<c:out value="${row.discussTemplate.templateDescription}" />">
	        </td>
	        ...
	        <td>
	        	<aof:code type="print" codeGroup="OPEN_YN" removeCodePrefix="true" selected="${row.discussTemplate.openYn}"></aof:code>
	        </td>
	        <td>
