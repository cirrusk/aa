...
doInitializeLocal = function() {
	...
	forSearch.config.url    = "<c:url value="/member/prof/list.do"/>";
	...
	forDetail.config.url    = "<c:url value="/member/prof/detail.do"/>";

	forCreate = $.action();
	forCreate.config.formId = "FormDetail";
	forCreate.config.url    = "<c:url value="/member/prof/create.do"/>";
    ...
    forUploadPopup.config.url            = "<c:url value="/member/prof/upload/popup.do"/>";
...
<body>
	...
	<thead>
		<tr>
			...
			<th><span class="sort" sortid="2"><spring:message code="필드:멤버:이름" /></span></th>
			<th><span class="sort" sortid="3"><spring:message code="필드:멤버:아이디" /></span></th>
			<th><span class="sort" sortid="6"><spring:message code="필드:멤버:회원구분" /></span></th>
	...
	<c:forEach var="row" items="${paginate.itemList}" varStatus="i">
		<tr>
	        ...
	        <td><aof:code type="print" codeGroup="PROF_TYPE" selected="${row.admin.profTypeCd }" /></td>
