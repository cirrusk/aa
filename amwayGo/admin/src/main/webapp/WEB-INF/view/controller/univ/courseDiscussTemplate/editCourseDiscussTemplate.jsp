...
doInitializeLocal = function() {
	...
	forUpdate.config.url             = "<c:url value="/univ/course/discuss/template/update.do"/>";
...
setValidate = function() {
	...
	forUpdate.validator.set({
		title : "<spring:message code="필드:토론:토론내용"/>",
...
<body>
	...
	<tbody>
		<tr>
			...
			<td>
				<input type="hidden" name="courseMasterSeq" value="<c:out value="${detail.discussTemplate.courseMasterSeq}"/>">
		...
		<tr>
			...
			<td>
				<input type="hidden" name="profMemberSeq" value="<c:out value="${detail.discussTemplate.profMemberSeq}"/>"/>
				...
				<input type="checkbox" name="openYn" value="Y" <c:if test="${detail.discussTemplate.openYn eq 'Y'}">checked="checked"</c:if>> <spring:message code="필드:템플릿:전체공개"/>
			</td>
		</tr>
		<tr>
			<th><spring:message code="필드:토론:토론주제"/><span class="star">*</span></th>
			<td>
				<input type="text" name="templateTitle" style="width:350px;" value="<c:out value="${detail.discussTemplate.templateTitle}"/>">
			</td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2">
				...
				<textarea name="templateDescription" id="templateDescription" style="width:99%; height:200px"><c:out value="${detail.discussTemplate.templateDescription}" /></textarea>
			</td>
		</tr>
		<tr>
			<th><spring:message code="필드:템플릿:사용여부"/><span class="star">*</span></th>
			<td>
				<aof:code name="useYn" type="radio" removeCodePrefix="true" codeGroup="USEYN" selected="${detail.discussTemplate.useYn}"></aof:code>
			</td>
		</tr>
	</tbody>
	</table>
