...
doInitializeLocal = function() {
	...
	forSearch.config.url    = "<c:url value="/member/cdms/list.do"/>";
	...
	forDetail.config.url    = "<c:url value="/member/cdms/detail.do"/>";

	forCreate = $.action();
	forCreate.config.formId = "FormDetail";
	forCreate.config.url    = "<c:url value="/member/cdms/create.do"/>";
	...
	forExcelDown.config.url    = "<c:url value="/member/cdms/excel.do"/>";
...
<body>
	...
	<thead>
		<tr>
			...
			<th><span class="sort" sortid="4"><spring:message code="필드:멤버:업무" /></span></th>
	...
	<c:forEach var="row" items="${paginate.itemList}" varStatus="i">
		<tr>
	        ...
	        <td><c:out value="${row.company.companyName}"/></td>
