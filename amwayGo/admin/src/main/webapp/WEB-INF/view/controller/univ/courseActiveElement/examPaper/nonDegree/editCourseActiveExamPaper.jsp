...
doInitializeLocal = function() {
	...
	forUpdate.config.url             = "<c:url value="/univ/course/active/exampaper/update.do"/>";
	...
	forDelete.config.url             = "<c:url value="/univ/course/active/exampaper/delete.do"/>";
...
setValidate = function() {
	...
	forUpdate.validator.set({
		message : "<spring:message code="필드:시험:응시시간"/>",
		name : "examTime",
		data : ["!null", "number"],
		check : {
            maxlength : 3
	        ...
	        <tr>
	        	...
	        	<td>
	        		...
	        		<span id="limitArea" style="display: none;">
		        		...
		        		<input type="text" name="limitProgress" class="align-r" style="width: 70px;" value="${detail.courseActiveExamPaper.limitProgress}">&nbsp; %<spring:message code="글:시험:이상"/>
	        		</span>
	        	</td>
	        </tr>
	        <tr>
	            ...
	            <td>
	            	<input type="text" name="retakeScore" class="align-r" style="width: 70px;" value="${detail.courseActiveExamPaper.retakeScore}">&nbsp;<spring:message code="글:시험:점"/>
	            </td>
	        </tr>
	        <tr>
	        	<th>
	            ...
	            <td>
	            	<input type="text" name="retakeCount" class="align-r" style="width: 70px;" value="${detail.courseActiveExamPaper.retakeCount}">&nbsp;<spring:message code="글:시험:회"/>
	            </td>
	        </tr>
	        <tr>
	            <th>
