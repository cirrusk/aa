...
doInitializeLocal = function() {
	...
	forSearch.config.url    = "<c:url value="/system/bbs/${boardType}/list.do"/>";
	...
	forDetail.config.url    = "<c:url value="/system/bbs/${boardType}/detail.do"/>";

	forCreate = $.action();
	forCreate.config.formId = "FormCreate";
	forCreate.config.url    = "<c:url value="/system/bbs/${boardType}/create.do"/>";
