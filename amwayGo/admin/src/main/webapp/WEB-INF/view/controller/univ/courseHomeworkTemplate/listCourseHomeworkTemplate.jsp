...
doInitializeLocal = function() {
	...
	forSearch.config.url    = "<c:url value="/univ/course/homework/template/list.do"/>";
	...
	forDetail.config.url    = "<c:url value="/univ/course/homework/template/detail.do"/>";

	forCreate = $.action();
	forCreate.config.formId = "FormDetail";
	forCreate.config.url    = "<c:url value="/univ/course/homework/template/create.do"/>";
...
<body>
	...
	<c:forEach var="row" items="${paginate.itemList}" varStatus="i">
		<tr>
	        ...
	        <td>
	        	<aof:code type="print" codeGroup="USEYN" removeCodePrefix="true" selected="${row.homeworkTemplate.useYn}"></aof:code>
	        </td>
