...
doInitializeLocal = function() {
	...
	forInsert.config.url             = "<c:url value="/member/prof/insert.do"/>";
...
<body>
	...
	<input type="hidden" name="joiningRolegroupSeq" value="3">
	...
	<tbody>
		<tr>
			...
			<input type="hidden" name="password" style="width:150px;" value="111111">
			<input type="hidden" name="verifyPassword" style="width:150px;" value="111111">
			<input type="hidden" name="profTypeCd" style="width:150px;" value="PROF_TYPE::001"><!-- Default : 과정담당자 -->
		</tr>
<%-- 		<tr>
			<th><spring:message code="필드:멤버:비밀번호"/><span class="star">*</span></th>
			<td colspan="4">
				<input type="hidden" name="password" style="width:150px;">
...
<%-- 		<tr>
			...
			<td colspan="4">
				<input type="hidden" name="verifyPassword" style="width:150px;">
		...
		<tr>
			...
			<td>
				<select name="sexCd" class="select">
					<aof:code type="option" codeGroup="SEX" />
				</select>
			</td>
<%-- 			<td rowspan="2">
...
<%--   		<tr>
			...
			<td>
				<select name="profTypeCd" class="select">
					<aof:code type="option" codeGroup="PROF_TYPE" />
				</select>
			</td>
			<th><spring:message code="필드:멤버:좌우명"/></th>
			<td>
				<input type="text" name="motto" style="width:200px;">
			</td>
