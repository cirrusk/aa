...
var REPLY = {
	...
	doInitializeLocal : function() {
		...
		REPLY.forListdata.config.url    = "<c:url value="/mypage/univ/course/group/bbs/${boardType}/list.do"/>";
		
		REPLY.forDetail = $.action();
		REPLY.forDetail.config.formId = "FormDetail";
		REPLY.forDetail.config.url    = "<c:url value="/mypage/univ/course/group/bbs/${boardType}/detail.do"/>";
