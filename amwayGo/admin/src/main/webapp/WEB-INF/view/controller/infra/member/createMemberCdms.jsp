...
doInitializeLocal = function() {
	...
	forInsert.config.url             = "<c:url value="/member/cdms/insert.do"/>";
...
setValidate = function() {
	...
	forInsert.validator.set({
		title : "<spring:message code="필드:멤버:소속"/>",
		name : "companySeq",
		data : ["!null"]
	});
	forInsert.validator.set({
		title : "<spring:message code="필드:멤버:업무"/>",
		name : "cdmsTaskTypeCd",
		data : ["!null"]
	});
	forInsert.validator.set({
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="2">
				...
				<input type="text" name="companyName" style="width:150px;" readonly="readonly" />
		...
		<tr>
			...
			<td colspan="2">
				<select name="cdmsTaskTypeCd" class="select">
					<option value=""><spring:message code="필드:멤버:업무"/></option>
					<aof:code type="option" codeGroup="CDMS_TASK" />
				</select>
			</td>
		</tr>
		<tr>
