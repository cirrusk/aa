...
doInitializeLocal = function() {
    ...
    forSearch.config.url    = "<c:url value="/univ/course/active/monitoring/non/list.do"/>";

    forListdata = $.action();
    forListdata.config.formId = "FormList";
    forListdata.config.url    = "<c:url value="/univ/course/active/monitoring/non/list.do"/>";
};
