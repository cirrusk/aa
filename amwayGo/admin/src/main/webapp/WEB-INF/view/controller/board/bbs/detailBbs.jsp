...
doInitializeLocal = function() {
	...
	forEdit.config.url    = "<c:url value="/system/bbs/${boardType}/edit.do"/>";
	
	forCreateReply = $.action();
	forCreateReply.config.formId = "FormCreate";
	forCreateReply.config.url    = "<c:url value="/system/bbs/${boardType}/create.do"/>";
	...
	forListReply.config.url         = "<c:url value="/system/bbs/${boardType}/reply/list/ajax.do"/>";
