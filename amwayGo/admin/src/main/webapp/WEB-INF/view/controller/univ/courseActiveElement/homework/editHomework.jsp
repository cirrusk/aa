...
doInitializeLocal = function() {
	...
	forTargetLayer.config.options.height = 550;
...
<div id="tabContainer">
	...
	<div class="lybox-title"><!-- lybox-title -->
	    <h4 class="section-title"><spring:message code="필드:과제:과제수정" /></h4>
	</div>
	    ...
	    <tbody>
	     ...
	     <c:if test="${param['shortcutCourseTypeCd'] ne CD_COURSE_TYPE_ALWAYS}">
	        ...
	        <tr>
	            ...
	            <td>
		             <c:if test="${appToday < detail.courseHomework.end2Dtime or detail.courseHomework.end2Dtime eq '' or empty detail.courseHomework.end2Dtime}">
		             ...
		             <c:if test="${appToday >= detail.courseHomework.start2Dtime and detail.courseHomework.start2Dtime ne '' and not empty detail.courseHomework.end2Dtime}">
	     ...
	     <c:if test="${param['shortcutCourseTypeCd'] eq CD_COURSE_TYPE_ALWAYS}">
	     	<tr>
				...
				<td>
	                ...
	                <input type="text" name="startDay" id="startDay" class="align-r" style="width: 50px;" value="<c:out value="${detail.courseHomework.startDay}"/>">&nbsp;
	                <spring:message code="글:일부터"/>
	                ~
	                <input type="text" name="endDay" id="endDay" class="align-r" style="width: 50px;" value="<c:out value="${detail.courseHomework.endDay}"/>">&nbsp;
