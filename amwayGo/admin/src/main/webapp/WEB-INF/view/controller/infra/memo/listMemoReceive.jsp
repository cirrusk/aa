...
doInitializeLocal = function() {
	...
	forSearch.config.url    = "<c:url value="/message/receive/list/iframe.do"/>";
	...
	forListdata.config.url    = "<c:url value="/message/receive/list/iframe.do"/>";
	...
	forDetail.config.url    = "<c:url value="/message/receive/detail/iframe.do"/>";

	forDeletelist = $.action("submit", {formId : "FormData"}); // validator를 사용하는 action은 formId를 생성시 setting한다
	forDeletelist.config.url             = "<c:url value="/message/receive/deletelist.do"/>";
