...
<%-- 공통코드 --%>
<c:set var="CD_CONTENT_TYPE_GENERAL" value="${aoffn:code('CD.CONTENT_TYPE.GENERAL')}"/>

<html>
<head>
<c:if test="${learning.contentTypeCd eq CD_CONTENT_TYPE_GENERAL and fn:contains(header['user-agent'], 'MSIE')}">
	<meta name="quirks" content="<!-- quirks mode -->">
</c:if>
<title></title>
<c:import url="simpleLearningScript.jsp"/>
<style>
body {background-color:#727272;padding:0px;margin:0px;}
</style>
</head>
