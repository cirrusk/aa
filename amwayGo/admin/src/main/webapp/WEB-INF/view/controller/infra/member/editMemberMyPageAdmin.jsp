...
<body>
	...
	<input type="hidden" name="editType" value="<c:out value="${editType}"/>"/>
	...
	<tbody>
		...
		<tr>
			...
			<td colspan="4"><c:out value="${detail.member.categoryOrganizationSeq}"/></td>
		</tr>
		<%--
		<tr>
		...
		<tr>
			...
			<td colspan="4"><input type="text" name="email" value="<c:out value="${detail.member.email}"/>" style="width:350px;"></td>
		</tr>
		<tr>
			<th><spring:message code="필드:멤버:집전화번호"/></th>
			<td colspan="4"><input type="text" name="phoneHome" value="<c:out value="${detail.member.phoneHome}"/>" style="width:150px;"></td>
		</tr>
		<tr>
			<th><spring:message code="필드:멤버:모바일전화번호"/></th>
			<td colspan="4"><input type="text" name="phoneMobile" value="<c:out value="${detail.member.phoneMobile}"/>" style="width:150px;"></td>
		</tr>
		<tr>
			<th><spring:message code="필드:멤버:계정상태"/></th>
			<td colspan="4"><aof:code type="print" codeGroup="MEMBER_STATUS" name="memberStatusCd" selected="${detail.member.memberStatusCd}"/></td>
