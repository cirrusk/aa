...
doInitializeLocal = function() {
    ...
    forDownloadExcel.config.url             = "<c:url value="/member/${memberType}/template/excel.do"/>";
    
	forUploadTemplateExcel = $.action();
	forUploadTemplateExcel.config.formId = "FormInsert";
    forUploadTemplateExcel.config.url             = "<c:url value="/member/${memberType}/attach/excel/save.do"/>";
...
<body>
   ...
   <form id="FormInsert" name="FormInsert" method="post" onsubmit="return false;">
    ...
    <tbody>
        <tr>
            <th><spring:message code="필드:엑셀:첨부파일"/></th>
            <td>
