...
doInitializeLocal = function() {
	...
	forSearch.config.url    = "<c:url value="/member/addressGroupMember/popup.do"/>";

	forListdata = $.action();
	forListdata.config.formId = "FormList";
	forListdata.config.url    = "<c:url value="/member/addressGroupMember/popup.do"/>";
...
<body>
	...
	<div class="vspace"></div>
		...
		<input type="hidden" name="addressGroupSeq" value="<c:out value="${condition.srchAddressGroupSeq}"/>" />
