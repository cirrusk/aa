...
doInitializeLocal = function() {
    ...
    forSearch.config.url    = "<c:url value="/univ/course/active/monitoring/mooc/list.do"/>";

    forListdata = $.action();
    forListdata.config.formId = "FormList";
    forListdata.config.url    = "<c:url value="/univ/course/active/monitoring/mooc/list.do"/>";
};
