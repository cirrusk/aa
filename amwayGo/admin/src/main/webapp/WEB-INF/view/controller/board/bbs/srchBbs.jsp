	...
	<div class="lybox search">
		<fieldset>
			...
			<c:if test="${boardType eq 'staff'}"> <%-- 교직원게시판 --%>
				<select name="srchTargetRolegroup" class="select">
					<option value=""><spring:message code="필드:게시판:대상자"/></option>
					<aof:code type="option" codeGroup="BBS_TARGET_ROLEGROUP" selected="${condition.srchTargetRolegroup}"/>
				</select>
			</c:if>
