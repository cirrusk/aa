...
<%-- 							<a class="audio" href="<c:out value="${aoffn:config('upload.context.exam')}${courseExamItem.filePath}"/>">audio</a> --%>
	...
	<td class="examExample <c:out value="${courseExamItem.examItemAlignCd}"/>">
	...
	<c:choose>
		<c:when test="${courseExamItem.examItemTypeCd eq CD_EXAM_ITEM_TYPE_004}">
			...
			<div class="text">
				...
				<input type="text" name="shortAnswers" class="input" style="width:90%;" value="<c:out value="${courseExamAnswer.shortAnswer}"/>">
