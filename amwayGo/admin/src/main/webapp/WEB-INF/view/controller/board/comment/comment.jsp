...
doInitializeLocalComment = function() {
	...
	forSearchComment.config.url         = "<c:url value="/comment/list/ajax.do"/>";
	...
	forListdataComment.config.url         = "<c:url value="/comment/list/ajax.do"/>";
	forListdataComment.config.fn.complete = function() {};
	
	forEditComment = $.action("layer");
	forEditComment.config.formId         = "FormEditComment";
	forEditComment.config.url            = "<c:url value="/comment/edit/popup.do"/>";
	...
	forDeleteComment.config.url             = "<c:url value="/comment/delete.do"/>";
	...
	forUpdateAgreeComment.config.url             = "<c:url value="/comment/agree/update.do"/>";
	...
	forUpdateDisagreeComment.config.url             = "<c:url value="/comment/disagree/update.do"/>";
