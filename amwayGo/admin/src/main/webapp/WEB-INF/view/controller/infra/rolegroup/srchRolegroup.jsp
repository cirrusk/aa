...
<c:set var="srchKey">rolegroupName=<spring:message code="필드:권한그룹:권한그룹명"/></c:set>
...
<form name="FormSrch" id="FormSrch" method="post" onsubmit="return false;">
	<div class="lybox search">
		<fieldset>
			...
			<select name="srchRoleCd">
				<option value=""><spring:message code="필드:전체"/></option>
				<aof:code type="option" codeGroup="ROLE" selected="${condition.srchRoleCd}"/>
			</select>
			<select name="srchKey">
...
<form name="FormSub" id="FormSub" method="post" onsubmit="return false;">
	...
	<input type="hidden" name="srchRolegroupSeq" />
	<input type="hidden" name="srchGroupOrder" />
	<input type="hidden" name="srchCfString" />
</form>
