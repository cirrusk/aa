...
var REPLY = {
	...
	doInitializeLocal : function() {
		...
		REPLY.forListdata.config.url    = "<c:url value="/mypage/system/bbs/${boardType}/list.do"/>";
		
		REPLY.forDetail = $.action();
		REPLY.forDetail.config.formId = "FormDetail";
		REPLY.forDetail.config.url    = "<c:url value="/mypage/system/bbs/${boardType}/detail.do"/>";
