...
doInitializeLocal = function() {
	...
	forUpdate.config.url             = "<c:url value="/member/password/update.do"/>";
		...
		<div class="section-password">
			<dl>
				...
				<dd>
					...
					<span class="comment"><spring:message code="글:멤버:6자이상입력하십시오"/></span>
				</dd>
				<dt><label for="check-pw"><spring:message code="필드:멤버:새비밀번호확인" /></label></dt>
				<dd>
					<input type="password" name="verifyPassword" style="width: 230px">
					<span class="comment"><spring:message code="글:멤버:변경할비밀번호다시한번입력하십시오"/></span>
				</dd>
			</dl>
