...
var REPLY = {
	...
	doInitializeLocal : function() {
		...
		REPLY.forListdata.config.url    = "<c:url value="/univ/course/bbs/dynamic/${boardSeq}/list/iframe.do"/>";
		
		REPLY.forDetail = $.action();
		REPLY.forDetail.config.formId = "FormDetail";
		REPLY.forDetail.config.url    = "<c:url value="/univ/course/bbs/dynamic/${boardSeq}/detail/iframe.do"/>";
