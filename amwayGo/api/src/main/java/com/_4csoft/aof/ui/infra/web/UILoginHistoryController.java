...
public class UILoginHistoryController extends BaseController {
	...
	public ModelAndView successLogin(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		//java.net.URL r = this.getClass().getClassLoader().getResource("com/_4csoft/aof/infra/support/security/AuthenticationSuccessHandler.class");
		//System.out.println("파일위치 : " + r.toString());

		int resultCode = SUCCESS;
		String param = HttpUtil.getParameter(req, "param", "");
		String type = HttpUtil.getParameter(req, "type", "");
		
		//java.net.URL r = this.getClass().getClassLoader().getResource("com/_4csoft/aof/ui/infra/api/UIMemberController.class");
		//System.out.println("경로 : " + r.toString());
