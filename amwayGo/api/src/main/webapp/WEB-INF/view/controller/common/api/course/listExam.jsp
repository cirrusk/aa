...
{
    "description" : "과정시험/퀴즈목록",
    "url" : "<c:url value="/api/course/exam/list"/>",
    "method" : "POST",
    "rest" : "<c:url value="/api/course/exam/list"/>",
    "request" : [
        {"name" : "accessToken", "type" : "String", "length" : "100", "required" : true, "defaults" : "", "description" : "인증키", "value" : ""},
        {"name" : "courseMasterSeq", "type" : "Long", "length" : "100", "required" : true, "defaults" : "", "description" : "마스터과정 일련번호", "value" : ""},
        ...
        {"name" : "srchKey", "type" : "String", "length" : "500", "required" : false, "defaults" : "", "description" : "검색구분(title) ", "value" : ""},
