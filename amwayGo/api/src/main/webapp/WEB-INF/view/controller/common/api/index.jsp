    ...
    menus : [
		{
			name : "common",
			menus : [
				{name : "info", file : "common/info"},
				{name : "디바이스 등록", file : "common/regDevice"},
				{name : "푸시전송", file : "common/sendPush"}
			]
		},     
		{
			name : "login",
		...
		},
		{
			name : "bbsComment",
			menus : [
				{name : "코멘트 등록", file : "bbsComment/insertBbsComment"},
				{name : "코멘트 삭제", file : "bbsComment/deleteBbsComment"}
			]
		},
		{
			name : "like",
			menus : [
				{name : "좋아요 등록", file : "like/insertLike"}
			]
		},
		{
			name : "ClassRoom",
			menus : [
				{name : "대회상태값", file : "classroom/competition"},
				{name : "연도학기 코드목록", file : "classroom/listYear"},
				{name : "수강과정 조회", file : "classroom/listMyCourse"},
				{name : "수강생 조회", file : "classroom/listApply"},
				...
				{name : "과정게시판 글 상세", file : "classroom/detailBbs"},
				{name : "과정게시판 글 등록(FileData)", file : "classroom/insertBbs"},
				{name : "과정게시판 글 삭제", file : "classroom/deleteBbs"},
				{name : "과정게시판 카테고리 목록", file : "classroom/listCatagory"},
				{name : "강의실 홈", file : "classroom/mainClassroom"},
				{name : "강의실 과제목록", file : "classroom/listHomeWork"},
				{name : "강의실 팀프로젝트리스트", file : "classroom/listTeamProjectList"},
				{name : "강의실 팀프로젝트세부목록", file : "classroom/listTeamProject"},
				{name : "강의실 팀프로젝트 게시물목록", file : "classroom/listTeamProjectBbs"},,
				{name : "강의실 팀프로젝트 게시물상세", file : "classroom/detailTeamProjectBbs"},
				{name : "강의실 팀프로젝트 게시물등록(FileData)", file : "classroom/insertTeamProjectBbs"},
				{name : "강의실 팀프로젝트 게시물삭제", file : "classroom/deleteTeamProjectBbs"},
				{name : "강의실 설문목록", file : "classroom/listSurvey"},
				{name : "강의실 설문", file : "classroom/detailSurvey"},
				{name : "강의실 설문 등록", file : "classroom/insertSurvey"},
				{name : "운영과정 목록", file : "classroom/listActiveCourse"},
				{name : "운영과정 상세조회", file : "classroom/detailCourseActive"},
			]
		},
		{
			name : "course",
			menus : [
				{name : "카테고리", file : "course/listCategory"},
				{name : "마스터과정조회", file : "course/listMaster"},
				{name : "마스터과정상세조회", file : "course/detailMaster"},
				{name : "문제목록", file : "course/listExam"},
				{name : "문제상세", file : "course/detailExam"},
				{name : "퀴즈결과목록", file : "course/listResultQuiz"},
				{name : "퀴즈결과상세", file : "course/detailResultQuiz"},
				{name : "퀴즈결과상세(주관식)", file : "course/detailShortResultQuiz"},
				{name : "수강생문제등록", file : "course/insertCourseQuizAnswer"}
			]
		},
		{
			name : "member",
			menus : [
				{name : "회원상세", file : "member/detailMember"},
				{name : "닉네임수정", file : "member/updateNickName"},
				{name : "약관내용 상세", file : "member/callAgreement"},
				{name : "개인정보동의", file : "member/updateAgreement"},
				{name : "닉네임 수정", file : "member/updateEncPassword"},
				{name : "비밀번호 수정", file : "member/updatePasswordMember"}
			]
		}
		,
		{
			name : "session",
			menus : [
				{name : "session상세", file : "session/detailSession"},
				{name : "session목록", file : "session/listSession"}
			]
		}		
