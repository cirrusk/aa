var SOCKET = {
	...
	roomSend : function(msg) {
		...
		if (_this.client === null) {
			...
			if ("object" === typeof msg && "string" === typeof msg.roomId && msg.roomId.length > 0 && "object" === typeof msg.message) {
	...
	oneSend : function(msg) {
		...
		if (_this.client === null) {
			...
			if ("object" === typeof msg && "string" === typeof msg.socketId && msg.socketId.length > 0 && "object" === typeof msg.message) {
	...
	// 전체 메시지 송신
	allSend : function(msg) {
		var _this = this;
		if (_this.client === null) {
			alert("Not connected.");
		} else {
			if ("object" === typeof msg && "object" === typeof msg.message) {
				_this.client.emit("all-send", msg); // 서버로 송신
			} else {
				alert("parameter is undefined.");
			}
		}
