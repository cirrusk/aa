 ...
 * @Package : com._4csoft.aof.ui.univ.vo.condition
 * @File : UIUnivCourseHomeworkTemplateCondition.java
 * @Title : 과제 템플릿 검색 condition
 * @date : 2014. 2. 20.
 * @author : 김현우
 * @descrption : 과제 템플릿 검색 condition
 */
public class UIUnivCourseHomeworkTemplateCondition extends SearchConditionVO implements Serializable {
