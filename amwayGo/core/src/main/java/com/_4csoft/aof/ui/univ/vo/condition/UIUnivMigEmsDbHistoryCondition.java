 ...
 * @Package : com._4csoft.aof.ui.univ.vo.condition
 * @File : UIUnivMigEmsDbHistoryCondition.java
 * @Title : {간단한 프로그램의 명칭을 기록}
 * @date : 2014. 2. 18.
 * @author : 이한구
 * @descrption : {상세한 프로그램의 용도를 기록}
 */
public class UIUnivMigEmsDbHistoryCondition extends ResultSet implements Serializable {
	private static final long serialVersionUID = 1L;

	public UIUnivMigEmsDbHistoryVO univMigEmsDbHistory;
