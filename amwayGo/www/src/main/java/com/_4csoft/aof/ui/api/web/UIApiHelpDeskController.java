 ...
 */
@Controller
public class UIApiHelpDeskController extends BaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/api/helpdesk/board/list.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/api/helpdesk/board/page/list.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/api/helpdesk/board/page/category/list.do")
