 ...
 * @Package : com._4csoft.aof.ui.univ.web
 * @File : UIUnivTeamProjectBbsController.java
 * @Title : 팀프로젝트 게시판
 * @date : 2014. 3. 11.
 * @author : 서진철
 ...
 */
@Controller
public class UIUnivTeamProjectBbsController extends UnivBaseController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/usr/classroom/bbs/teamproject/list.do")
	public ModelAndView listTeamProjectBbs(HttpServletRequest req, HttpServletResponse res, UIUnivCourseActiveVO courseActive, UIUnivCourseApplyVO courseApply,
		...
		setCourseActive(req, courseActive, projectTeam);
		...
		mav.setViewName("/univ/classroom/teamproject/board/bbs/listBbs");
		return mav;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping (value = { "/usr/classroom/bbs/teamproject/detail.do" })
	public ModelAndView detail(HttpServletRequest req, HttpServletResponse res, UIUnivCourseActiveVO courseActive, UIUnivCourseApplyVO courseApply,
			UIUnivCourseTeamProjectVO teamProject, UIUnivCourseTeamProjectTeamVO projectTeam, UIUnivCourseTeamProjectBbsCondition condition,
			UIUnivCourseTeamProjectBbsVO bbs) throws Exception {
		ModelAndView mav = new ModelAndView();
		...
		mav.setViewName("/univ/classroom/teamproject/board/bbs/detailBbs");
		return mav;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping (value = { "/usr/classroom/bbs/teamproject/create.do" })
	public ModelAndView create(HttpServletRequest req, HttpServletResponse res, UIUnivCourseActiveVO courseActive, UIUnivCourseApplyVO courseApply,
			UIUnivCourseTeamProjectVO teamProject, UIUnivCourseTeamProjectTeamVO projectTeam, UIUnivCourseTeamProjectBbsVO bbs,
		...
		mav.setViewName("/univ/classroom/teamproject/board/bbs/createBbs");
		return mav;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping (value = { "/usr/classroom/bbs/teamproject/edit.do" })
	public ModelAndView edit(HttpServletRequest req, HttpServletResponse res, UIUnivCourseActiveVO courseActive, UIUnivCourseApplyVO courseApply,
		...
		mav.setViewName("/univ/classroom/teamproject/board/bbs/editBbs");
		return mav;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping (value = { "/usr/classroom/bbs/teamproject/reply/list/ajax.do" })
	public ModelAndView list(HttpServletRequest req, HttpServletResponse res, UIUnivCourseTeamProjectBbsVO bbs) throws Exception {
		...
		mav.setViewName("/univ/classroom/teamproject/board/bbs/listReplyBbsAjax");
		return mav;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/usr/classroom/bbs/teamproject/insert.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/usr/classroom/bbs/teamproject/update.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/usr/classroom/bbs/teamproject/delete.do")
