...
import com._4csoft.aof.ui.api.dto.MessageAddressGroupDTO;
import com._4csoft.aof.ui.api.dto.MessageReceiveDTO;
 ...
 */
@Controller
public class UIApiMypageController extends BaseController{
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/api/mypage/contact/list.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/api/mypage/message/list.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/api/mypage/message/delete.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping ("/api/mypage/message/send/insert.do")
