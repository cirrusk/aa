...
<c:set var="srchKey">receiveMemberName=<spring:message code="필드:쪽지:받은사람"/>,message=<spring:message code="필드:쪽지:쪽지내용"/></c:set>
...
<form name="FormDetail" id="FormDetail" method="post" onsubmit="return false;">
	...
	<input type="hidden" name="messageSendSeq" />
	<input type="hidden" name="receiveMemberNames" />
	<input type="hidden" name="readCount" />
	<input type="hidden" name="messageReceiveSeq" />	
</form>
