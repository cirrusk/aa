...
var forCreateAddressGroup = null;
...
doInitializeLocal = function() {
	...
	forSearch.config.url    = "<c:url value="/usr/memo/address/group/group/list.do"/>";
	...
	forDeletelist.config.url             = "<c:url value="/usr/memo/address/group/group/deletelist.do"/>";
