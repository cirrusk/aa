...
doInitializeLocal = function() {
	...
	forInsert.config.url             = "<c:url value="/usr/classroom/bbs/discuss/insert.do"/>";
...
<div class="lybox-title">
    ...
    <spring:message code="글:토론:토론게시글등록" />
    </h4>
</div>
				...
				<c:if test="${replyYn eq 'Y'}">
					...
					<tbody>
						<tr>
							...
							<td>
								<aof:code type="print" codeGroup="DISCUSS_BBS_TYPE" selected="${detailParentBbs.bbs.bbsTypeCd}"/>
							</td>
						</tr>
						<tr>
					...
					<tr>
						...
						<td>
							<select name="bbsTypeCd">
								<aof:code type="option" codeGroup="DISCUSS_BBS_TYPE" />
							</select>
						</td>
					</tr>
					<tr>
