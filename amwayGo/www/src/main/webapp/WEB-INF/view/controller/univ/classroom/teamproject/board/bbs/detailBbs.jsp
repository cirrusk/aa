...
<head>
<title><spring:message code="필드:팀프로젝트:팀프로젝트" />&nbsp;<spring:message code="글:상세조회" /></title>
...
doInitializeLocal = function() {
	...
	forEdit.config.url    = "<c:url value="/usr/classroom/bbs/${boardType}/edit.do"/>";
	
	forCreateReply = $.action();
	forCreateReply.config.formId = "FormCreate";
	forCreateReply.config.url    = "<c:url value="/usr/classroom/bbs/${boardType}/create.do"/>";
	...
	forListReply.config.url         = "<c:url value="/usr/classroom/bbs/${boardType}/reply/list/ajax.do"/>";
