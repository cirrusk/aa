...
<head>
<title><spring:message code="글:수정" /></title>
...
doInitializeLocal = function() {
	...
	forUpdate.config.url             = "<c:url value="/usr/classroom/bbs/${boardType}/update.do"/>";
	...
	forDelete.config.url             = "<c:url value="/usr/classroom/bbs/${boardType}/delete.do"/>";
