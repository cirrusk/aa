...
<head>
<title><spring:message code="필드:팀프로젝트:팀프로젝트" />&nbsp;<spring:message code="필드:팀프로젝트:게시판" /></title>
...
doInitializeLocal = function() {
	...
	forSearch.config.url    = "<c:url value="/usr/classroom/bbs/${boardType}/list.do"/>";

	forListdata = $.action();
	forListdata.config.formId = "FormList";
	forListdata.config.url    = "<c:url value="/usr/classroom/bbs/${boardType}/list.do"/>";
	
	forDetail = $.action();
	forDetail.config.formId = "FormDetail";
	forDetail.config.url    = "<c:url value="/usr/classroom/bbs/${boardType}/detail.do"/>";

	forCreate = $.action();
	forCreate.config.formId = "FormCreate";
	forCreate.config.url    = "<c:url value="/usr/classroom/bbs/${boardType}/create.do"/>";

	forEditBoard = $.action("layer");
	forEditBoard.config.formId = "FormEditBoard";
	forEditBoard.config.url    = "<c:url value="/board/edit/popup.do"/>";
			...
			<c:otherwise>
				...
				<div class="lybox-btn">
					<div class="lybox-btn-r">
						...
						<c:if test="${boardType ne 'notice' and boardType ne 'faq' and boardType ne 'resource' and appToday >= homeworkStartDtime and appToday <= homeworkEndDtime}">
