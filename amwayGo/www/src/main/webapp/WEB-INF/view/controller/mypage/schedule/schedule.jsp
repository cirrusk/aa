...
doInitializeLocal = function() {
	...
	forCreate.config.url    = "<c:url value="/usr/schedule/create.do"/>";
	...
	forEdit.config.url    = "<c:url value="/usr/schedule/edit.do"/>";
	...
	forDetail.config.url    = "<c:url value="/usr/schedule/detail.do"/>";
	...
	forListdata.config.url    = "<c:url value="/usr/schedule/list.do"/>";
	...
	forUpdate.config.url             = "<c:url value="/usr/date/update.do"/>";
