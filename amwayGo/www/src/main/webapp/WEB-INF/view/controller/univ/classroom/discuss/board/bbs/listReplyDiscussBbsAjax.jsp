...
var REPLY = {
	...
	doInitializeLocal : function() {
		...
		REPLY.forListdata.config.url    = "<c:url value="/usr/classroom/bbs/discuss/reply/list/ajax.do"/>";
		
		REPLY.forDetail = $.action();
		REPLY.forDetail.config.formId = "FormDetail";
		REPLY.forDetail.config.url    = "<c:url value="/usr/classroom/bbs/discuss/detail/iframe.do"/>";
