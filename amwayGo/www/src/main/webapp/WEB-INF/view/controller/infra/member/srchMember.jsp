...
<form name="FormSrch" id="FormSrch" method="post" onsubmit="return false;">
	<div class="lybox">
		...
		<c:if test="${memberType eq 'prof' or memberType eq 'user'}">
		<span>
		...
		<c:if test="${memberType eq 'user' }">
			...
			<select name="srchStudentStatusCd" class="select">
				<option value=""><spring:message code="필드:멤버:학적상태"/></option>
				<aof:code type="option" codeGroup="STUDENT_STATUS" selected="${condition.srchStudentStatusCd}" />
			</select>
		</c:if>
