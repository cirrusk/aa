...
doInitializeLocal = function() {
	...
	forUpdate.config.url             = "<c:url value="/usr/classroom/bbs/discuss/update.do"/>";
	...
	forDelete.config.url             = "<c:url value="/usr/classroom/bbs/discuss/delete.do"/>";
...
<div class="lybox-title">
    ...
    <spring:message code="글:토론:토론게시글수정" />
    </h4>
</div>
	...
	<c:otherwise>
		...
		<c:choose>
			...
			<c:otherwise>
					...
					<tr>
						...
						<td>
							<select name="bbsTypeCd">
								<aof:code type="option" codeGroup="DISCUSS_BBS_TYPE" selected="${detailBbs.bbs.bbsTypeCd}"/>
							</select>
						</td>
					</tr>
					<tr>
				...
				<div class="lybox-btn">
					<div class="lybox-btn-l" style="margin-top: 0px;">
