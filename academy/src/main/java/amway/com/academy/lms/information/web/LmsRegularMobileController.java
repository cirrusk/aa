 ...
 */
@Controller
@RequestMapping("/mobile/lms/information")
public class LmsRegularMobileController {
	/** log */
	...
	public ModelAndView lmsRegular(ModelMap model, HttpServletRequest request, RequestBox requestBox) throws Exception{
		...
		if( requestUrl.indexOf("http://localhost") >= 0 ) {
			sHybrisDomain = "http://localhost:8080/mobile";
			sParam = ".do";
		}
		...
		// 메인 화면 호출
		mav = new ModelAndView("/mobile/lms/information/lmsRegular");
