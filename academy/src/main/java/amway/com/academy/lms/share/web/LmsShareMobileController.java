 ...
 * 
 * @PROJ :AI ECM 1.5 
 * @NAME :CopyOfLmsShareMobileController.java
 * @DESC : 무권한 페이지 상세 화면 (모바일)
...
@Controller
@RequestMapping("/mobile/lms/share")
public class LmsShareMobileController {
	
	/** log */
	@SuppressWarnings("unused")
	private static final Logger LOGGER = LoggerFactory.getLogger(LmsShareMobileController.class);
