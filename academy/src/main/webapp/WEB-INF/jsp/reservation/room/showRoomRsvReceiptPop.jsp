...
<html style="margin: 0; height: 100%" lang="ko">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/thirdparty/report/crownix-viewer.min.css">
		<style type="text/css">
		...
		<script src="/_ui/desktop/common/js/jquery-1.11.0.min.js"></script>
		<script src="${receiptCrownix}"></script>
		<script src="${rdSolution}"></script>
		<script type="text/javascript">
			$(document).ready(function(){
				...
				$.rdSolution.data.mrdPath =  '${mrdPath}';
				$.rdSolution.data.mrdParam = '';
				$.rdSolution.data.serverUrl = '${reportingServer}';
...
<!-- 	<body onload="$.rdSolution.rdopen()" leftmargin="0px" rightmargin="0px" topmargin="0px" bottommargin="0px"> -->
	<body leftmargin="0px" rightmargin="0px" topmargin="0px" bottommargin="0px">
		...
		<form id="form1" name="form1" action="${reportingServer}" method="post" target="pdfframe">
