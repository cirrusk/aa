...
function callList(page, back){
	$.ajaxCall({
   		url: "/mobile/lms/request/lmsLive.do"
		...
		<section id="pbContent" class="academyWrap">
			...
			<div class="acSubWrap" id="articleDiv">
				...
				<c:if test="${empty courseList and (scrData.page eq '1' or scrData.page eq '0')  }">
					<article class="item">
						<div class="nodata">등록된 라이브교육이 없습니다.</div>
					</article>
				</c:if>	
...
<form name="goViewForm" id="goViewForm" action="/mobile/lms/request/lmsLiveView.do">
