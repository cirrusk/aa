...
<body class="uiGnbM3">
		...
		<section id="pbContent" class="academyWrap">
			...
			<c:if test="${!empty detail.item2.penaltynote }">
				...
				<a href="/mobile/lms/request/lmsLive.do?back=Y&page=${param.page }&courseid=${detail.item.courseid }#data${detail.item.courseid }" class="btnList"><span>목록</span></a>
			</div>
