						...
						<c:when test="${scrData.giveopen eq 'Y' and itemp.giveflag ne 'N'}">
							<c:choose>
								<c:when test="${itemp.planstatus eq 'Y'}">
									<li><p>사전계획 <a href="#none" class="insertBtn" onclick="javascript:listEvent.planPage('${itemp.giveyear}','${itemp.givemonth}','person','S')"><span>조회</span></a></p>
										<div class="tailMsg">
											<ul>
								...
								<c:otherwise>
									<li class="on"><p>사전계획 <a href="#none" class="insertBtn on" onclick="javascript:listEvent.planPage('${itemp.giveyear}','${itemp.givemonth}','person','I')">
						...
						<c:when test="${scrData.giveopen eq 'Y' and itemp.giveflag eq 'N'}">
							<c:choose>
								<c:when test="${item.planstatus eq 'Y'}">
									<li><p>사전계획 <a href="#none" class="insertBtn" onclick="javascript:listEvent.planPage('${itemp.giveyear}','${itemp.givemonth}','person','S')"><span>조회</span></a></p></li>
									<li><p>지출증빙 <span>-</span></p></li>
								</c:when>
								<c:otherwise>
									<td>
								...
								<c:when test="${itemp.planstatus eq 'Y'}">
									...
									<c:choose>
										<c:when test="${itemp.spendstatus eq 'Y'}">
											<li><p>지출증빙<a href="#none" class="insertBtn" onclick="javascript:listEvent.spendPage('${itemp.giveyear}','${itemp.givemonth}','person','S')"><span>조회</span></a></p>
												<div class="tailMsg">
													<ul>
										...
										<c:otherwise>
											<li class="on"><p>지출증빙<a href="#none" class="insertBtn on" onclick="javascript:listEvent.spendPage('${itemp.giveyear}','${itemp.givemonth}','person','I')"><span>${itemp.spendcnt }</span></a></p>
												<div class="tailMsg">
													<ul>
														<li>그룹: ${itemp.grpamount }원</li>
														<li>개인: ${itemp.peramount }원</li>
						...
						<c:when test="${scrData.giveopen eq 'Y' and itemp.giveflag eq 'N'}">
							<c:choose>
								<c:when test="${item.planstatus eq 'Y'}">
									...
									<c:choose>
										<c:when test="${itemp.spendstatus eq 'Y'}">
											<li><p>지출증빙<a href="#none" class="insertBtn" onclick="javascript:listEvent.spendPage('${itemp.giveyear}','${itemp.givemonth}','person','S')"><span>조회</span></a></p></li>
										</c:when>
										<c:otherwise>
											<li><p>지출증빙 <span>-</span></p></li>
										</c:otherwise>
