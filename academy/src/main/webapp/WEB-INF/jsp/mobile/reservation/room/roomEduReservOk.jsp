...
System.out.println(">>> /WEB-INF/jsp/mobile/reservation/room/roomEduReservOk.jsp");
%>
...
function accessParentPageEdu(){
	var newUrl = "/reservation/roomEduForm/";
	...
	<section class="mWrap">
		...
		<div class="stepDone selcWrap" id="stepDone">
			...
			<div class="btnWrap aNumb2">
				<a href="#" onclick="javascript:accessParentPageEdu();" class="btnBasicGL">예약계속하기</a>
