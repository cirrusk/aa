...
function setPpInfoList(){
	...
	$.ajaxCall({
		url: "<c:url value='/mobile/reservation/roomEduPpInfoListAjax.do'/>"
		, type : "POST"
		, async : false
...
// 			html += "<a href=\"javascript:calendar('"+yearMonthList[num].year+"', '"+yearMonthList[num].month+"');\"  class=\"on\">"+yearMonthList[num].month+""
		}else{
...
/* get json attribute from html object */
	...
	$.ajax({
		...
		, success: function(data, textStatus, jqXHR){
			if(data){
				...
				$("#paymentFrame").contents().find("#reserved2").val("edu");
...
<div id="pbContainer">
	<section id="pbContent" class="bizroom">
		<section class="brIntro">
			<h2><a href="#uiToggle_01">교육장 예약 필수 안내</a></h2>
...
<!-- 								<a href="#none" class="btnTbl">AP안내</a> -->
							...
							<div class="roomInfo">
								...
								<div class="roomImg touchSliderWrap">
									...
									<div class="touchSlider" id="touchSlider">
										<ul>
											<li><img src="/_ui/desktop/images/academy/@aproom1.gif" alt="강서 AP 퀸룸" /></li>
											<li><img src="/_ui/desktop/images/academy/@aproom1.gif" alt="강서 AP 퀸룸" /></li>
										</ul>
									</div>
			...
			<div class="bizEduPlace" id="selectStepTwo">
				<div class="result">
					<div class="tWrap">
						...
						<span>총?건<em class="bar">|</em>결제예정금액 : 0원</span>
								...
								<table class="creditTbl">
									...
									<tbody id="normalPayment">
										...
										<tr>
											...
											<label for="cardid" />비밀번호 앞 2자리</label></td>
										</tr>
										<tr>
											<th>할부기간</th>
			...
			<div class="stepDone selcWrap" id="stepDone">
				...
				<div class="btnWrap aNumb2">
					<a href="/mobile/reservation/roomEduForm.do" class="btnBasicGL">예약계속하기</a>
