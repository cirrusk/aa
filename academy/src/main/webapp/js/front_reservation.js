...
//	    timeout: opts.timeout,
	    ...
	    error: function (xhr, textStatus, errorThrown) {
	    	...
	    	try{
	    		top.window.location.href = "http://www.abnkorea.co.kr";
	    	}catch(e){}
	    },
...
var showLoading = function () {
	...
	//console.log($("#pbContainer").width()/2);
//	var tmp  = '<div id="loading" class="loadingS" style="display: table-cell; vertical-align: middle;">'
	
	var tmp  = '<div id="loading" style="position: fixed; top: 0px; right: 0px; width: 100%; height: 100%; display: block;">'
...
$.fn.spendItemsMoblie = function (pHtml) {
	...
	function html(num) {
		...
		addDom += "<p><input type='file' name='file"+num+"' id='file"+num+"' title='사진 찾기' onChange='javascript:html.filesize(this,"+num+");' /></p>";
		addDom += "<p><input type='hidden' name='filekey' id='filekey"+num+"' title='파일번호' value='' />";
...
{
	var iHeight = $("#pbContent").height() + 50;
	var isResize = false;
	if(iHeight == null){
