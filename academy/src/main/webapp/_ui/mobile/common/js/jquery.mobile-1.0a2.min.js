...
activeBtnClass:"ui-btn-active",ajaxLinksEnabled:true,ajaxFormsEnabled:true,transitions:["slide","slideup","slidedown","pop","flip","fade"],defaultTransition:"slide",loadingMessage:"loading",metaViewportContent:"",gradeA:function(){return a.support.mediaquery}});a(e.document).trigger("mobileinit");if(a.mobile.gradeA()){var m=a(e),o=a("html"),t=a("head"),w=a.mobile.loadingMessage?a('<div class="ui-loader ui-body-a ui-corner-all"><span class="ui-icon ui-icon-loading spin"></span><h1>'+
