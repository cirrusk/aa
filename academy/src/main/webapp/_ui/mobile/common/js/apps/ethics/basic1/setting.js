...
function set_page(){
	...
	content += "<img id=\"image\" src=\"/_ui/mobile/images/content/ethics/basic1/images/"+ito(curPage)+".jpg\" width=\"100%\" onclick=\"javascript:controls_toggle();\"/>";
	if(data == "N"){ // 일반페이지
		content += "<audio id=\"audio1\">";
		content += "<source src=\""+navi_linkfile[curPage-1]+"\" type=\"audio/mpeg\">";
		content += "</audio>";
		if(navi_page.length == curPage){content += "<img id=\"completed_img\" src=\"/_ui/mobile/images/content/ethics/basic1/img/end.jpg\" onclick=\"javascript:complete_education();\"/>";}
	...
	if(curPage == navi_page.length){
		...
		$('#navi-next').children().remove();
		$('#navi-next').append("<img src=\"/_ui/mobile/images/content/ethics/basic1/img/icon_fw80.png\" height=\"80px\"/>");
	}
